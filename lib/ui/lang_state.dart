        ...
        body: SafeArea(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Padding(
                padding:
                    EdgeInsets.only(left: _width * .1, bottom: _width * .05),
                child: Text(
                  "Welcome there",
              ...
              Padding(
                padding:
                    EdgeInsets.only(left: _width * .1, bottom: _height * .1),
                child: Text(
  ...
  Widget _buildLang() {
    ...
    return DecoratedBox(
      ...
      child: Column(
        ...
        return InkWell(
            onTap: () {
              _sharedPreferences.setString("lang", "$i").then((_) async {
                Navigator.of(context).pushReplacement(MaterialPageRoute(
                    builder: (context) => AuthScreen(
                          route: MainScreen(),
                        )));
                final s = await _sharedPreferences.getString("lang");
              });
            },
            child: i == 1
                ? DecoratedBox(
